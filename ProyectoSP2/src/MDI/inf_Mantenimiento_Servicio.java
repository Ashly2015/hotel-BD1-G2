 ...
 * @author ranbr
 */
public class inf_Mantenimiento_Servicio extends javax.swing.JInternalFrame {
     /**
 *
 ...
 */
    public void tablas() {
        try {
            ...
            PreparedStatement pstt4 = cn.prepareStatement("select * from servicios");
    ...
    /**
     * Creates new form inf_Mantenimiento_Servicio
     */
    ...
    public void bitacora_guardar(){
        ...
        String descrip="Registró el sericio "+prov;
    ...
    public void bitacora_modificar(){
        String prov=txt_nombre.getText();
        String descrip="Modificó el servicio "+prov;
       //Desciframos la fecha
        java.util.Date fechaN = fecha.getDate();
        long fecha = fechaN.getTime();
        java.sql.Date dateN = new java.sql.Date(fecha);
    ...
    public void bitacora_eliminar(){
       String prov=txt_nombre.getText();
        String descrip="Eliminó el servicio "+prov;
       //Desciframos la fecha
        java.util.Date fechaN = fecha.getDate();
        long fecha = fechaN.getTime();
        java.sql.Date dateN = new java.sql.Date(fecha);
    ...
    public void bitacora_buscar(){
        String prov=txt_nombre.getText();
        String descrip="Buscó el servicio "+prov;
       //Desciframos la fecha
        java.util.Date fechaN = fecha.getDate();
        long fecha = fechaN.getTime();
        java.sql.Date dateN = new java.sql.Date(fecha);
    ...
    public inf_Mantenimiento_Servicio() {
        initComponents();
        tablas();
        get_usuario();
        get_fecha();
    ...
    private void initComponents() {
        ...
        label3.setText("Nombre del Servicio:");
        ...
        tbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Servicio", "Nombre Servicio", "Estado"
            }
        ) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            Connection cn = DriverManager.getConnection(mdi_Principal.BD, mdi_Principal.Usuario, mdi_Principal.Contraseña);
            PreparedStatement pst = cn.prepareStatement("delete from servicios where id_servicio = ?");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            Connection cn = DriverManager.getConnection(mdi_Principal.BD, mdi_Principal.Usuario, mdi_Principal.Contraseña);
            PreparedStatement pst = cn.prepareStatement("select * from servicios where id_servicio =?");
            pst.setString(1, txtbuscado.getText().trim());

            ResultSet rs = pst.executeQuery();

            if (rs.next()) {
                txt_nombre.setText(rs.getString("nombre_servicio"));
                txt_estado.setText(rs.getString("estatus_servicio"));
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try {
            ...
            Connection cn = DriverManager.getConnection(mdi_Principal.BD, mdi_Principal.Usuario, mdi_Principal.Contraseña);
            PreparedStatement pst = cn.prepareStatement("update servicios set  nombre_servicio = ?, estatus_servicio = ?  where id_servicio =" + ID);
            String mensaje = "";
